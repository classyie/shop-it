    ...
    return (<>
        <nav className="navbar navbar-expand-lg navbar-light bg-light">
          ...
          <a className="nav-link disabled" href="#" tabindex="-1" aria-disabled="true">Disabled</a>
                    ...
                    <ul class="navbar-right cart-right">
                        <li><img src={cartimg} alt="cartImg" className='cart-img' /><a href="#" id="cart"><i class="fa fa-shopping-cart"></i> Cart <span class="badge">3</span></a></li>
                    </ul>
                </div>
            </div>
        </nav>
